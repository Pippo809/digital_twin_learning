...
# PLY reader
# from digital_twin_learning.models.KPConv.ply import read_ply, write_ply

# Metrics
from .metrics import IoU_from_confusions, fast_confusion
from digital_twin_learning.models.KPConv.KPConfig import Config
from sklearn.neighbors import KDTree

from digital_twin_learning.models.KPConv.blocks import KPConv
...
class ModelTrainer:
    ...
    def __init__(self, net, config, chkp_path=None, finetune=False, on_gpu=True):
        ...
        if (chkp_path is not None and os.path.exists(chkp_path)):
            if finetune:
    ...
    def train(self, net, training_loader, val_loader, config):
        ...
        for epoch in range(config.max_epoch):
            ...
            self.step = 0
            for (points, labels, start, end) in training_loader:
